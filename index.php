...
<?php get_header(); ?>
      ...
      <div class="container">
        <div class="row heading">
          ...
          <div class="col-sm-12 col-md-12 col-lg-6">
            <h3 class="heading__title mb-40">Título apresentando a empresa
            </h3>
          </div><!-- /.col-lg-6 -->
          <div class="col-sm-12 col-md-12 col-lg-6">
            <p>Aqui fica a ideia de ter algum texto dando uma pequena prévia da empresa, seus serviços e as vantagens
              para quem contrata os serviços, ou algo nesse sentido.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vitae dui sed lorem mattis efficitur eu
              vel sem. Vivamus congue ipsum non hendrerit fringilla. Mauris vel ex neque. Proin et iaculis mi. Vivamus
              lobortis porttitor vehicula. Sed eleifend enim nulla, vel pretium nibh lobortis molestie.</p>
          </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6">
      ...
      <div class="container">
        <div class="row heading mb-40">
          ...
          <div class="col-sm-12 col-md-12 col-lg-5">
            <p class="heading__desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vitae dui sed lorem
              mattis efficitur eu vel sem. Vivamus congue ipsum non hendrerit fringilla. Mauris vel ex neque. Proin et
              iaculis mi. Vivamus lobortis porttitor vehicula. Sed eleifend enim nulla, vel pretium nibh lobortis
              molestie. Proin id neque eget sem aliquet tincidunt. Suspendisse facilisis neque elit, non consectetur
              libero rutrum ac. Fusce orci mi, mollis ut nulla eu, feugiat pulvinar diam.</p>
          </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
    ...
    <section class="features-layout1 pb-50">
      ...
      <div class="container">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 justify-content-between mb-30">
          <div class="col-12 btn-wrapper">
            <a href="#" class="btn btn__primary btn__primary-style2 btn__icon mt-30 mb-30">
              <span>Explore todos nossos serviços</span>
              <i class="icon-arrow-right"></i>
            </a>
          </div><!-- /.col-12 -->
        </div><!-- /.col-lg-6 -->
        ...
        <div class="row">
            ...
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.html">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/blog/grid/1.jpg" alt="blog image">
                </a>
              </div><!-- /.blog-img -->
          ...
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.html">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/blog/grid/2.jpg" alt="blog image">
                </a>
              </div><!-- /.blog-img -->
              <div class="post__content">
                <div class="post__meta d-flex flex-wrap">
          ...
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="post-item">
              <div class="post__img">
                <a href="blog-single-post.html">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/blog/grid/3.jpg" alt="blog image">
                </a>
              </div><!-- /.blog-img -->
              <div class="post__content">
                <div class="post__meta d-flex flex-wrap">
