...
<?php
// Template Name: Construção de Chatbots
?>
<?php get_header(); ?>
<script type="text/javascript">
    ...
    <section class="page-title page-title-layout9 bg-overlay bg-overlay-gradient bg-parallax">
      <div class="bg-img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/page-titles/chatbot.jpg" alt="background"></div>
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
            <h1 class="pagetitle__heading">Construção de Chatbots</h1>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
            <div class="heading mb-40">
              ...
              <h3 class="heading__title mb-40">O que é e como funciona um chatbot?
              </h3>
            </div>
          </div><!-- /.col-xl-5 -->
        </div><!-- /.row -->
        <div class="row about__Text">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
            <div class=" position-relative">
              ...
              <p>As tecnologias digitais têm criado nas pessoas um grande senso de imediatismo, como explica a professora Tereza Cristina Melo de Brito Carvalho, em uma publicação do Jornal da USP.</p>
              <p>Para lidar com esse novo perfil de público, que exige respostas imediatas para as suas demandas, usar um chatbot pode ser a melhor saída para as empresas.</p>
              <p>Com esse tipo de tecnologia, o atendimento aos clientes é agilizado e gera muito mais satisfação. É por isso que você precisa pensar em adotar estratégias com chatbots no seu negócio.</p>

              
              <h5>Afinal, o que é um chatbot?</h5>
              <p>Podemos definir um chatbot como um robô de conversação, que utiliza recursos de inteligência artificial para simular conversas e interações.</p>
              <p>Ou seja, o chatbot é um recurso que pode ser usado em aplicativos mensageiros, como WhatsApp, Telegram, Facebook Messenger e chats, em geral, para agilizar a comunicação com os públicos de um negócio.</p>
              <p>Essa ferramenta possibilita que o usuário tenha a sensação de estar conversando com outra pessoa, tendo em vista como as mensagens são precisas e complexas.</p>
              ...
              <h5>Como os chatbots funcionam?</h5>
              <p>Os chatbots funcionam com base nas linguagens de inteligência artificial, que simulam o pensamento humano. Assim, conforme identificam uma pergunta, acessam uma base de conhecimento e encontram uma resposta adequada.</p>
              <p>Ao criar um chatbot, os desenvolvedores desse tipo de tecnologia cadastram na base de dados do programa, uma série de perguntas que podem ser feitas pelos usuários que entram em contato com uma empresa via chat.</p>
              <p>Um hotel, por exemplo, pode cadastrar respostas para perguntas sobre o preço da diária, os tipos de apartamento disponíveis, se há café da manhã incluso etc.</p>
              <p>A ideia é que os robôs respondam a todas essas perguntas automaticamente, sem que um atendente humano tenha que desperdiçar o seu tempo respondendo a questionamentos simples e repetitivos.</p>

              <h5>Quais são as principais vantagens do chatbot para o marketing das empresas?</h5>
              <p>As vantagens do chatbot para o marketing das empresas são muitas. Para começar, temos a questão da agilidade, já que as respostas são enviadas de forma imediata.</p>
              <p>Ou seja, se um usuário mandar uma mensagem pelo WhatsApp durante a madrugada ou em um final de semana, não precisa esperar até o próximo dia útil para ter uma resposta. O seu questionamento será respondido no ato!</p>
              <p>Isso tudo acaba gerando muito mais satisfação nos usuários, que se sentirão bem atendidos e poderão se converter em clientes da empresa.</p>
              <p>Esse bom relacionamento com os públicos também acaba gerando um buzz positivo da marca. Ou seja, os clientes satisfeitos falarão bem do atendimento da sua empresa para os seus amigos, familiares e outras pessoas com quem mantém relações. Isso fará com que mais usuários entrem em contato com você e se tornem clientes.</p>
              <p>Os chatbots são o futuro da comunicação digital e trazem muitos benefícios para as marcas, conforme apontamos aqui. Por isso, considere adotar essa estratégia vencedora no seu negócio.</p>


              <h3 align="center" class="heading__title mt-40">A Index desenvolve chatbots completos para agilizar o seu processo de atendimento em seu site, Facebook ou WhatsApp. <a href="https://conteudo.indexdc.com.br/especialistas/">Entre em contato conosco e converse com nossos especialistas! </a>
              </h3>
            </div>
